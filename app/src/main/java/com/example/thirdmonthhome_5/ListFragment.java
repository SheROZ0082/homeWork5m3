...
public class ListFragment extends Fragment {
   ...
   Button addButton;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                chats.add(0,new ChatModel(R.drawable.img120,"New Chat",""));
    ...
    private void setChats() {
        chats = new ArrayList<>();
        chats.add(new ChatModel(R.drawable.img120,"Geectecth50-3","Rozmuhammed"));
        chats.add(new ChatModel(R.drawable.img120,"GeekStudents","Rozmuhammed"));
        chats.add(new ChatModel(R.drawable.img120,"DevKG","Продам PlayStation"));
        chats.add(new ChatModel(R.drawable.img120,"Java","Java 2022"));
        chats.add(new ChatModel(R.drawable.img120,"Книги для IT","скачать книгу"));
        chats.add(new ChatModel(R.drawable.img120,"Geectecth50-3","Rozmuhammed"));
        chats.add(new ChatModel(R.drawable.img120,"GeekStudents","Rozmuhammed"));
        chats.add(new ChatModel(R.drawable.img120,"DevKG","Продам PlayStation"));
        chats.add(new ChatModel(R.drawable.img120,"Java","Java 2022"));
